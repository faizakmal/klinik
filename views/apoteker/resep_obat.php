        ...
        <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <td>
                  ...
                  <?php
                      if($row['status'] == 'Belum Diterima'){ ?>
                        <a href="resep_obat_konfirmasi.php?id=<?php echo $row['id_mr'];?>"><button type='button' class='btn btn-success' title='Konfirmasi'> <i class='fas fa-check'></i></button> </a> 
                  <?php  }  ?>
        ...
        <div class="container-fluid">
          <h5><center>Apakah Anda Yakin Menghapus Resep ini ?</center></h5> 
                ...
                <div class="modal-footer">
                  <form method="POST" action="../../controller/apoteker/konfirmasi_resep.php?id=<?php echo $row['id_mr']; ?>">
