        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Periksa Pasien Gigi</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Kunjungan Pasien Gigi</h3>
        ...
        <div class="card-body">
         ...
         <div class="card-footer">
            <button name="simpan_gigi" type="submit" class="btn btn-success float-sm-right"> Simpan</button>
            <?php include ('../../controller/admin/medical_record.php'); ?>
         </div>
      </form>
        <!-- /.card-body -->
      </div>
